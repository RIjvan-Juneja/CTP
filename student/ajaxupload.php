            ...
            if (move_uploaded_file($tmp, $path)) {
                ...
                if ($ex->num_rows == 0) {
                    ...
                    if ($result) {
                        ...
                        if ($name == "Aadhar_card") {
                            $update = $con->prepare(
                                "UPDATE tbl_application_documents SET aadharcard = ? WHERE student_id = ?"
                            );
                            $update->bind_param(
                                "si",
                                $final_image,
                            ...
                            $update = $con->prepare(
                                "UPDATE tbl_application_documents SET ssc_marksheet = ? WHERE student_id = ?"
                            );
                            $update->bind_param(
                                "si",
                                $final_image,
                            ...
                            $update = $con->prepare(
                                "UPDATE tbl_application_documents SET hsc_marksheet = ? WHERE student_id = ?"
                            );
                            $update->bind_param(
                                "si",
                                $final_image,
                            ...
                            $update = $con->prepare(
                                "UPDATE tbl_application_documents SET other_documents = ? WHERE student_id = ?"
                            );
                            $update->bind_param(
                                "si",
                                $final_image,
